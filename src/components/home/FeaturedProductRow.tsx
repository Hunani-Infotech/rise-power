...
export function FeaturedProductRow({
  ...
  return (
    <Link
      ...
      className="group relative block min-h-[26rem] scroll-mt-28 overflow-hidden rounded-2xl sm:min-h-[30rem] lg:min-h-[34rem]"
    >
      {imageSrc ? (
        <Image
          src={imageSrc}
      ...
      <div
        className="absolute inset-0 bg-gradient-to-t from-[#060806]/94 via-[#060806]/40 to-transparent transition-[opacity,background] duration-500 group-hover:from-[#060806]/96 group-hover:via-[#060806]/55"
        aria-hidden
      />
