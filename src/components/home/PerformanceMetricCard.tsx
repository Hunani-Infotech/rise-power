  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 className="mt-5 max-w-[14rem] text-center font-display text-[14px] leading-snug font-bold tracking-[0.14em] text-[#1a1c16] uppercase sm:max-w-[16rem] sm:text-[15px] lg:text-[17px]">
          {title}
        </h3>
