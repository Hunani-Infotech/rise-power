  ...
  products: [
    {
      ...
      body: "Man-portable power with unlimited runtime via 30-second cartridge swap—under 15 lbs, sub-ambient quiet.",
      runtime: "UNLIMITED",
    ...
    },
    {
      ...
      body: "Plug-and-play range extender for LiPo drones—4+ hours flight, up to 5× lithium range for ISR missions.",
      runtime: "4+ HOURS",
    ...
    },
    {
      ...
      body: "3 kW silent generator for sustained field ops—extreme temperatures, zero heat signature.",
      runtime: "CONTINUOUS",
    ...
    },
    {
      ...
      body: "RFID-smart, leak-proof cartridges for rapid field replenishment—swap and restore runtime without tools.",
      runtime: "15 YEARS",
